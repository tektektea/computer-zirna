                ...
                <div id="md_en" data-target="out_en" className="agreement_md"><h1>Privacy Policy</h1>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Application</strong> means the software program provided by the Company
                                downloaded by You on any electronic device, named citycomp</p>
                        </li>
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
                                this Agreement) refers to Computerzirna.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Computerzirna, accessible from <a
                                href="http://computerzirna.in" rel="external nofollow noopener"
                                target="_blank">http://computerzirna.in</a></p>
                        </li>
                        <li>
                    ...
                    <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal
                        ...
                        close Your web browser. Learn more about cookies: <a
                            href="https://www.freeprivacypolicy.com/blog/cookies/" target="_blank">Cookies: What Do They
                            Do?</a>.</p>
                    ...
                    <ul>
                        <li>By visiting this page on our website: <a href="http://computerzirna.in/contact"
                                                                     rel="external nofollow noopener"
                                                                     target="_blank">http://computerzirna.in/contact</a>
                        </li>
                    </ul>
                </div>
            </div>
